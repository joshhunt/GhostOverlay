...
{
    /// <summary>
    /// EqualHeightWrapPanel is a panel that position child control vertically or horizontally based on the orientation and when max width / max height is reached a new row (in case of horizontal) or column (in case of vertical) is created to fit new controls.
    /// </summary>
    public partial class EqualHeightWrapPanel : Panel
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the orientation of the EqualHeightWrapPanel.
        ...
        {
            if (d is EqualHeightWrapPanel wp)
            {
