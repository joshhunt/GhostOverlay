...
namespace BungieNetApi.Model
{
    ...
    public partial class InlineResponse20063 :  IEquatable<InlineResponse20063>, IValidatableObject
    {
        ...
        public InlineResponse20063(TrendingTrendingDetail response = default(TrendingTrendingDetail), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
