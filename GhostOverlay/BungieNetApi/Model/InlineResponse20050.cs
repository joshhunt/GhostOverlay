...
namespace BungieNetApi.Model
{
    ...
    public partial class InlineResponse20050 :  IEquatable<InlineResponse20050>, IValidatableObject
    {
        ...
        public InlineResponse20050(List<DestinyHistoricalStatsDestinyClanAggregateStat> response = default(List<DestinyHistoricalStatsDestinyClanAggregateStat>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
