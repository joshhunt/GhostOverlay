...
namespace BungieNetApi.Model
{
    ...
    public partial class InlineResponse20035 :  IEquatable<InlineResponse20035>, IValidatableObject
    {
        ...
        public InlineResponse20035(List<UserUserInfoCard> response = default(List<UserUserInfoCard>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
