...
namespace BungieNetApi.Model
{
    ...
    public partial class InlineResponse20051 :  IEquatable<InlineResponse20051>, IValidatableObject
    {
        ...
        public InlineResponse20051(DestinyDefinitionsDestinyEntitySearchResult response = default(DestinyDefinitionsDestinyEntitySearchResult), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
