...
namespace BungieNetApi.Model
{
    ...
    public partial class InlineResponse20028 :  IEquatable<InlineResponse20028>, IValidatableObject
    {
        ...
        public InlineResponse20028(GroupsV2GetGroupsForMemberResponse response = default(GroupsV2GetGroupsForMemberResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
