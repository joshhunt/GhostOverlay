...
namespace BungieNetApi.Model
{
    ...
    public partial class InlineResponse20056 :  IEquatable<InlineResponse20056>, IValidatableObject
    {
        ...
        public InlineResponse20056(DestinyHistoricalStatsDestinyAggregateActivityResults response = default(DestinyHistoricalStatsDestinyAggregateActivityResults), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
