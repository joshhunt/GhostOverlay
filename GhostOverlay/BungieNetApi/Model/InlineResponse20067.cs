...
namespace BungieNetApi.Model
{
    ...
    public partial class InlineResponse20067 :  IEquatable<InlineResponse20067>, IValidatableObject
    {
        ...
        public InlineResponse20067(CommonModelsCoreSettingsConfiguration response = default(CommonModelsCoreSettingsConfiguration), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
