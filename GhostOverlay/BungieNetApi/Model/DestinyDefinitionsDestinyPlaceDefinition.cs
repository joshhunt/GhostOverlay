...
namespace BungieNetApi.Model
{
    ...
    public partial class DestinyDefinitionsDestinyPlaceDefinition :  IEquatable<DestinyDefinitionsDestinyPlaceDefinition>, IValidatableObject
    {
        ...
        public DestinyDefinitionsDestinyPlaceDefinition(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition displayProperties = default(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition), long hash = default(long), int index = default(int), bool redacted = default(bool))
        {
