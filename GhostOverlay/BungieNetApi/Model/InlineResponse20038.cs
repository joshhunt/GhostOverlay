...
namespace BungieNetApi.Model
{
    ...
    public partial class InlineResponse20038 :  IEquatable<InlineResponse20038>, IValidatableObject
    {
        ...
        public InlineResponse20038(DestinyResponsesDestinyCharacterResponse response = default(DestinyResponsesDestinyCharacterResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
