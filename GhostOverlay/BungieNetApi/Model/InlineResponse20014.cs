...
namespace BungieNetApi.Model
{
    ...
    public partial class InlineResponse20014 :  IEquatable<InlineResponse20014>, IValidatableObject
    {
        ...
        public InlineResponse20014(List<ForumForumRecruitmentDetail> response = default(List<ForumForumRecruitmentDetail>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
