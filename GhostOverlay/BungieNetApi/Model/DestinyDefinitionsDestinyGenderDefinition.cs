...
namespace BungieNetApi.Model
{
    ...
    public partial class DestinyDefinitionsDestinyGenderDefinition :  IEquatable<DestinyDefinitionsDestinyGenderDefinition>, IValidatableObject
    {
        ...
        public DestinyDefinitionsDestinyGenderDefinition(int genderType = default(int), DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition displayProperties = default(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition), long hash = default(long), int index = default(int), bool redacted = default(bool))
        {
