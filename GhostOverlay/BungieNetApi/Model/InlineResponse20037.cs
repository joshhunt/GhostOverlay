...
namespace BungieNetApi.Model
{
    ...
    public partial class InlineResponse20037 :  IEquatable<InlineResponse20037>, IValidatableObject
    {
        ...
        public InlineResponse20037(DestinyResponsesDestinyProfileResponse response = default(DestinyResponsesDestinyProfileResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
