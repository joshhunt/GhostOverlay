...
namespace BungieNetApi.Model
{
    ...
    public partial class InlineResponse20024 :  IEquatable<InlineResponse20024>, IValidatableObject
    {
        ...
        public InlineResponse20024(GroupsV2GroupMemberLeaveResult response = default(GroupsV2GroupMemberLeaveResult), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
