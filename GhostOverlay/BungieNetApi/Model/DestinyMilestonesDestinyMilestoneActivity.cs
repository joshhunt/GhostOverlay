...
namespace BungieNetApi.Model
{
    ...
    public partial class DestinyMilestonesDestinyMilestoneActivity :  IEquatable<DestinyMilestonesDestinyMilestoneActivity>, IValidatableObject
    {
        ...
        public DestinyMilestonesDestinyMilestoneActivity(long activityHash = default(long), long activityModeHash = default(long), ActivityModeTypeEnum? activityModeType = default(ActivityModeTypeEnum?), List<long> modifierHashes = default(List<long>), List<DestinyMilestonesDestinyMilestoneActivityVariant> variants = default(List<DestinyMilestonesDestinyMilestoneActivityVariant>))
        {
