...
namespace BungieNetApi.Model
{
    ...
    public partial class InlineResponse20027 :  IEquatable<InlineResponse20027>, IValidatableObject
    {
        ...
        public InlineResponse20027(List<EntitiesEntityActionResult> response = default(List<EntitiesEntityActionResult>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
