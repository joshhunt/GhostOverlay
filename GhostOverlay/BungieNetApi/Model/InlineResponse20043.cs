...
namespace BungieNetApi.Model
{
    ...
    public partial class InlineResponse20043 :  IEquatable<InlineResponse20043>, IValidatableObject
    {
        ...
        public InlineResponse20043(DestinyResponsesDestinyPublicVendorsResponse response = default(DestinyResponsesDestinyPublicVendorsResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
